...
public class Enlace {
    ...
    public void insertarTrabajador(SueldosTrabajadores st) {
    ...
    public ArrayList<SueldosTrabajadores> obtenerDataSueldos() {
        ...
        try {
            ...
            while (rs.next()) {
                SueldosTrabajadores miSueldo = new SueldosTrabajadores(rs.getString("cedula"),
